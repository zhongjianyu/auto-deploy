...
public class A implements TemplateDirectiveModel {
	...
	public A(AutWidgetRoleService autWidgetRoleService) {
	...
	public void execute(Environment environment, Map map, TemplateModel[] model, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		String href = hrefObj == null ? null : ((SimpleScalar) hrefObj).getAsString();
		...
		button.append("<a href=\"" + href + "\" class=\"" + aclass + "\" id=\"" + id + "\" onclick=\"" + onclick + "\">");
		if (iclass != null) {
